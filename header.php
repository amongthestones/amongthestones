...
<div id="page" class="hfeed site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'sinxelo' ); ?></a>
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="site-branding">
			...
			if ( $description || is_customize_preview() ) : ?>
				<p class="site-description"><mark><?php echo $description; /* WPCS: xss ok. */ ?></mark></p>
			<?php
			endif; ?>
